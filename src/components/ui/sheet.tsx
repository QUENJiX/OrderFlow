...
const sheetVariants = cva(
  "fixed z-50 flex flex-col gap-4 bg-popover shadow-xl transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300",
  {
    variants: {
      side: {
...
function SheetHeader({
  ...
  return (
    <div
      className={cn("grid gap-1 border-b border-border p-5", className)}
      {...props}
    />
  );
}
